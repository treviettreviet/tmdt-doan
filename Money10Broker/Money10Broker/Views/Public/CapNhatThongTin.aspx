...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<div id="note-content-warning" class="note-content-warning" style="font-size:12px;">		
		<p>Ví của bạn chưa được Ecmoney10broker.tk chứng thực. Hãy chứng thực để:</p>
		...
		<p style="font-style:italic;"> - Đăng ký tích hợp Nâng cao vào website bán hàng của bạn và nhiều tính năng tiện ích khác được Ecmoney10broker.tk hỗ trợ...</p>
    ...
    <div id="menu-vertical-right-content">
		<div class="menu-vertical-right-content">
            ...
            <tr>
			 ...
			 <tr>
			  ...
			  <tr>
				...
				<td><img src="../../Content/images/un_verif.png" style="float:left">&nbsp;&nbsp;&nbsp;[ <a href="#">Chứng thực</a> ]</td>
			  </tr>
			<tr>
            ...
            <tr>
            	...
            	<td>Sử dụng điện thoại di động<span style="margin-left:10px;">[ <a href="#">Thay đổi</a> ]</span></td>
            </tr>
			<tr>
                <th>Địa chỉ nhận hàng:</th>
                <td> <span style="margin-left:10px;">[ <a href="#">Khai báo</a> ]</span></td>
            </tr>       
            </table>				
        </div>
		<div class="menu-vertical-right-content">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td>quangkhai1289@gmail.com [ <a href="#">Thay đổi</a> ]</td>
              </tr>
              <tr>
                <th>Số điện thoại di động chính:</th>
                <td>01698726280 [ <a href="">Thay đổi</a> ]</td>
              </tr>
              <tr>
                <th>Tài khoản Ngân hàng mặc định:</th>
                <td> [ <a href="">Khai báo</a> ]</td>
              </tr>
