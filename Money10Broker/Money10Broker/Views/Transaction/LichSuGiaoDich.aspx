...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="title">
        <span class="yel">Lịch sử giao dịch trên hệ thống</span></div>
    <%
    ...
    <div id="balance-activities">
        <div id="balance-activities-content">
            ...
            <p id="balance-activities-content-view">
                <span id="balance-content" class="yel">
                    <%=tk.SoDu.ToString()%></span><br />
    ...
    <div id="transaction-history-sell-filter" class="box-content-square">
        ...
        <div id="sall-filter-advance" class="sall-filter" style="display: none; padding-bottom: 10px">
            <div class="row-sall-filter" style="margin: 0">
                <table style="margin-bottom: 0">
                    <tr>
                        <td>
                            <label>
                                Từ ngày</label>
                            <input id="date_from" class="date-picker date-time" name="date_from" style="width: 65px"
                                type="text" value="01/11/2011" />
                        </td>
                        <td>
                            <label>
                                Đến ngày</label>
                            <input id="date_to" class="date-picker date-time" name="date_to" style="width: 65px"
                                type="text" value="01/01/2012" />
                        </td>
                        <td>
                            <label>
                                Từ khóa</label><br />
                        ...
                        <td>
                            ...
                            <select id="ser_type" name="ser_type" onchange="set_status(this.value)" style="width: 130px;
                                height: 22px;">
    ...
    <div id="transaction-history" class="box-content-square">
        <div id="transaction-history-title">
            ...
            <div id="popup-applicant" style="display: none; position: absolute; width: 220px;
                ...
                <p style="color: #FF7007; font-size: 13px">
                    <strong>CÁC TRƯỜNG CẦN TRÍCH XUẤT</strong><span style="float: right"><a href="javascript:;"
                        onclick="close_popup();"><img src="../../Content/images/close-me.gif" /></a></span></p>
                <br />
                <input id="checkall" checked="checked" name="checkall" type="checkbox" value="0" />
                Tất cả<br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input checked="checked" name="arr_ex[]1"
                    type="checkbox" value="1" />
                Mã GD<br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input checked="checked" name="arr_ex[]2"
                    type="checkbox" value="2" />
                Thời gian phát sinh<br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input checked="checked" name="arr_ex[]3"
                    type="checkbox" value="3" />
                Thời gian thanh toán<br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input checked="checked" name="arr_ex[]4"
                    type="checkbox" value="4" />
                Loại giao dịch<br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input checked="checked" name="arr_ex[]5"
                    type="checkbox" value="5" />
                Hình thức<br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input checked="checked" name="arr_ex[]6"
                    type="checkbox" value="6" />
                Số tiền<br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input checked="checked" name="arr_ex[]7"
                    type="checkbox" value="7" />
                Tình trạng<br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input checked="checked" name="arr_ex[]8"
                    type="checkbox" value="8" />
                Đối tác<br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input checked="checked" name="arr_ex[]9"
                    type="checkbox" value="9" />
                Email<br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input checked="checked" name="arr_ex[]10"
                    type="checkbox" value="10" />
                Điện thoại<br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input checked="checked" name="arr_ex[]11"
                    type="checkbox" value="11" />
                Địa chỉ nhận hàng<br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input checked="checked" name="arr_ex[]12"
                    type="checkbox" value="12" />
                Mã đơn hàng<br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input checked="checked" name="arr_ex[]"
        ...
        <div id="label-table" style="border-top: 0; background-color: #fff;">
            ...
            <div id="bottom-transaction-detail0" style="margin: 0; float: left; padding-left: 25px">
                <span class="icon-title" style="padding-left: 5px;">Biểu tượng: </span><span class="pay_direct">
                    NGAY</span> <span class="pay_escrow">TẠM GIỮ</span>
            </div>
            <div style="float: right; height: 16px;">
                <span style="color: #555; font-weight: bold;">Màu sắc:&nbsp;&nbsp;</span>
                <img align="absmiddle" src="../../Content/images/icon_tra.gif" />
                <span>Chưa thực hiện</span>
                <img align="absmiddle" src="../../Content/images/icon_trb.gif" />
                <span>Đang tạm giữ</span>
                <img align="absmiddle" src="../../Content/images/icon_trc.gif" />
