        ...
        <div id="menu-nav-content-c">
            ...
            <div id="menu-nav-content-sub">
                <ul>
                    ...
                    <li class="active " style="display: block"><a href="/Transaction/ChuyenTien"><span>Chuyển
                        tiền</span></a></li>
                    <li class=" " style="display: block"><a href="/Transaction/ChuyenTienCungMoigioi"><span>
                        Chuyển tiền cùng môi giới</span></a></li>
    ...
    <div class="box-content">
        <div class="box-content-square" style="padding-top: 0;">
			...
			<!-- thông báo lỗi--><div class="message-box"></div><!--hết thông báo lỗi-->
                ...
                %>
                <form method="post" name="form1" action="/Transaction/TransferByBroker" enctype="multipart/form-data">
                <input type="hidden" name="form_module_id" value="451">
                <table border="0" cellspacing="10" cellpadding="0" width="100%">
                    <p style="margin-left: 80px;">
                        <input type="radio" name="idsamediff" value="samebank" checked="checked" onclick="GetBank('samebank');"
                            id="id_account_per"><label for="id_account_per"><span class="font-acc">Chuyển tiền cùng
                                ngân hàng</span><span class="font-acc-command">(Chuyển tiền trong cũng một ngân hàng)</span></label></p>
                    ...
                    <p style="margin-left: 80px;">
                        <input type="radio" name="idsamediff" value="diffbank" onclick="GetBank('diffbank');"
                            id="id_account_merchant"><label for="id_account_merchant"><span class="font-acc">Chuyển
                                tiền liên ngân hàng</span><span class="font-acc-command">(Chuyển tiền giữa hai ngân
                                    hàng khác nhau)</span></label></p>
                    <p id='optiondiffbank' style="margin-left: 100px;">
                        <label id="diffbanksend">
                            Send Bank</label><br>
                        ...
                        <br>
                        <label id="diffbankreceive">
                            Receive Bank</label><br>
                    ...
                    <tr>
                        <th>
                            <span class="required">*</span>Số thẻ người gửi:
                        </th>
                        <td>
                            <input name="sendcardnum" id="sendcardnum" type="text" value="" onkeydown="return isNumber(event)">
                        </td>
                    </tr>
                    <tr>
                        <th>
                            <span class="required">*</span>Số thẻ người nhận:
                        </th>
                        <td>
                            <input name="receivecardnum" id="receivecardnum" type="text" value="" onkeydown="return isNumber(event)">
                            <span class="field-check-function submit" title="notEmpty(_value_)">Chưa nhập số tiền
                                muốn rút</span><span class="field-check-function blur submit" title="isAmount(_value_)">Số
                                    tiền muốn rút nhập không đúng yêu cầu</span>
                        </td>
                    </tr>
                    <tr>
                        <th>
                            <span class="required">*</span>Số tiền muốn chuyển khoản
                        </th>
                        <td>
                            <input name="amount" id="amount" type="text" value="" maxlength="16" class="" autocomplete="off"
                                onkeydown="return isNumber(event)"><span class="span-grey"> (VND)</span> <span class="field-check-function submit"
                                    title="notEmpty(_value_)">Chưa nhập số tiền muốn rút</span><span class="field-check-function blur submit"
                                        title="isAmount(_value_)">Số tiền muốn rút nhập không đúng yêu cầu</span>
                        </td>
                    </tr>
                    <tr class="cashout-fee">
                        ...
                        <td>
                            <strong>Theo phí chuyển khoản quy định của từng ngân hàng</strong>
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <input name="btnSubmit" type="submit" value="Chuyển Tiền" class="button-content">
                        </td>
                    </tr>
                </table>
                </form>
