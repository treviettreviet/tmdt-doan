            ...
            <div class="menu-vertical-right-content-form">
                <div id="menu-vertical-right-content">
                    ...
                    <div class="menu-vertical-right-content">
                        ...
                        <form name="formtt" method="post" action="/Account/XuLyCapNhatTaiKhoanCaNhan">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td><input name="txthoten" type="text" value="<%=HoTen %>" />
                                    <%--<strong></strong>--%>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="checkbox" name="email" onclick="enable_text(this.checked)"><span style="color: Red">Thay
                                        đổi thông tin</span>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <div class="menu-vertical-right-content">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input name="txtemail" type="text" value="<%=Email %>" />
                                    <input type="checkbox" name="chkcheck" onclick="enable_text(this.checked)"><span
                                        style="color: Red">Thay đổi thông tin</span>
                                </td>
                            </tr>
                            <tr>
                                <th>
