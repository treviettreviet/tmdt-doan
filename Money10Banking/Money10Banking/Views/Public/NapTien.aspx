    ...
    <div id="Main">
        ...
        <div class="form-container" id="form_nap_tien">
            <div class="text_header">
                <span class="title">Nạp tiền</span> <span>Nạp tiền Online vào thẻ ATM của Ngân hàng</span></div>
            <div class="form">
                <%--<div class="form-tab">
	<ul>
		    <li class="selected">
            ...
            <div class="form-content">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input style="text-align: right" class="qtip" size="10" autocomplete="off" onkeypress="return numbersonly(this, event)"
                                    title="Nhập vào số tiền muốn chuyển" id="amount" type="text" value name="amount"><b>₫</b><div
                                        style="font-weight: bold; padding-right: 3px;" id="detail_amount">
                                    </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <input style="text-align: right" class="qtip" size="10" autocomplete="off" onkeypress="return numbersonly(this, event)"
                                    title="Nhập vào số tiền thực nhận" id="receive" type="text" value name="receive"><b>₫</b><div
                                        style="font-weight: bold; padding-right: 3px;" id="detail_receive">
                                    </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <span class="explain_message">(Số tiền nạp phải nằm trong khoản từ 30.000<b>₫</b> đến
                                    100.000.000<b>₫</b>)</span>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <span id="bankFee">0 </span><b>₫</b> <span class="explain_message">(=0<b>₫</b> phí cố
                                    định + 0% số tiền giao dịch)</span>
                            </td>
                        </tr>
                        <tr>
                            <th>
				...
				<td><input type="text" name="captcha" value class="text qtip" size="10" autocomplete="off" title="Nhập mã an toàn giống như trong ảnh trên.<br/>Trong trường hợp không nhìn rõ chữ, bạn có thể thay đổi mã an toàn bằng cách nhấn vào nút <img src='/application/captcha/Refresh_48.png' style='vertical-align:top;height:24px' alt='refresh'/> bên phải"></td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="submit" name="submit" value="Nạp tiền" class="button">
                            </td>
                        </tr>
                    </tbody>
                </table>
