<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DangNhap_ThatBai.aspx.cs" Inherits="MoiGioi_Money10.WebForm6" %>
        ...
        <div id="login-box-left">			
           <div id="login-box-left-content">
                ...
                <div id="login-box-content">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td><input name="verify_image" type="text" value maxlength="5" autocomplete="off" style="width:70px; float:left; margin-right:5px;"><img src="../images/captcha0.gif"></td>
                      </tr>
                      <tr>
                        <th>&nbsp;</th>
                ...
                <div id="login-rigister">
                    ...
                    <p><a href="https://www.nganluong.vn/?portal=nganluong&amp;page=user_register"><img src="../images/button-r.gif"></a></p>
