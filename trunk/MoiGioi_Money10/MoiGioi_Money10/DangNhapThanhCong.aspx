<%@ Page Title="" Language="C#" MasterPageFile="~/Site_TTTaiKhoan.Master" AutoEventWireup="true" CodeBehind="DangNhapThanhCong.aspx.cs" Inherits="MoiGioi_Money10.WebForm15" %>
...
<div id="menu-nav-content">
	...
	<div id="menu-nav-content-c">
		<div id="menu-nav-content-main">
			<ul>
				...
				<li class="active " style="display:block"><a href="../images/Thanh toán trực tuyến - An toàn với thanh toán Tạm giữ, bảo hiểm người mua - NgangLuong.vn.html"><span>GIAO DỊCH</span></a></li>
		...
		<div id="menu-nav-content-sub">
			<ul>
				...
				<li class="active " style="display:block"><a href="../images/Thanh toán trực tuyến - An toàn với thanh toán Tạm giữ, bảo hiểm người mua - NgangLuong.vn.html"><span>Tổng hợp</span></a></li>
	...
	#th-r h3 {
		background:url(webskins/skins/nganluong/images/bg-box-title.gif) repeat-x scroll 0 0 transparent;
	...
	#th-r .install-account h3{
		background:url(webskins/skins/nganluong/images/bg-box-title.gif) repeat-x 0 0;
		height:26px;
		line-height:26px;
		color:#555;
	...
	.install-account li{
		...
		list-style:none;
		padding-left:12px;
		background:url(webskins/skins/nganluong/images/bulit-.gif) no-repeat 0 6px;
		}
	...
	line-height:30px;
	height:30px;
	background:url(webskins/skins/nganluong/images/bg-tab-content-transaction-top.gif) repeat-x 0 100%;
	padding-left:5px;
	vertical-align:middle;
	}

#transaction-history-title .icon-ex{
	background:url(webskins/skins/nganluong/images/icon-exel.gif) no-repeat 0 0;
	padding-left:20px;
	margin-right:10px;
	margin-left:10px;
	}
...
<div id="th-r" style="float:right;width:222px;">
	...
	<div class="myaccount-adv" style="border: 1px solid #eee;margin-top:5px;">
		<a href="http://event.nganluong.vn/tientrieu/?utm_source=banner_onsite&utm_medium=news&utm_campaign=Vietcombank" target="_blank"><img src="https://www.nganluong.vn/data/images/nganluong/vietcombank.gif" style="width:220px;"/></a>
	</div>
	-->
</div><div id="th-l">
	<div class="box-content-square" id="transaction-history" style="width:698px;">
		<div id="transaction-history-title">
			...
			<p style="color:#FF7007; font-size:13px"><span style="float:left;font-weight:bold;">CÁC TRƯỜNG TRÍCH XUẤT</span><span style="float:right"><a href="javascript:;" onclick="close_popup();"><img src="../images/close-message.gif" style="padding-top:0px;"></a></span></p>
			<br>
