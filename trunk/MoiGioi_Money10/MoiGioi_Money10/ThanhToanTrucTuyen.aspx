<%@ Page Title="" Language="C#" MasterPageFile="~/Site_ThanhToan.Master" AutoEventWireup="true" CodeBehind="ThanhToanTrucTuyen.aspx.cs" Inherits="MoiGioi_Money10.WebForm17" %>
...
$(function() {
                ...
                <div id="box-payment0" class="box box-processing">
                    <div class="btn-payment">
                        ...
                        <div class="btn-payment-bank">
                            <a class="button-payment-bank button-payment-type" href="">Thanh toán bằng tài 
                            khoản Ngân hàng hoặc Tiền mặt</a></div>
                        <div class="btn-payment-NL">
                            <a class="button-payment-nl button-payment-type" href="">Thanh toán bằng số dư 
                            ví điện tử NgânLượng.vn</a></div>
                    </div>
                    <div class="clear">
                    </div>
                </div>
	...
	<!-- END BlockPaymentOptions -->
	    <div id="option-payment-type" class="box main-box box-payment" 
            style="display: none;">
            <div class="main-title">
                <ul>
                    <li class="active">
				...
				-->
                    ...
                    <div class="row-bank">
                        <div class="title-row-bank active">
							...
							<span class="name-title">Online dùng thẻ ATM</span> <span class="charge">(Miễn 
                            phí)</span> </a>
                        </div>
                        <div class="row-bank-c">
                            <ul>
                    ...
                    <div class="row-bank">
                        <div class="title-row-bank active">
                            ...
                            <span class="charge">(Miễn phí)</span> </a>
                        </div>
                        <div class="row-bank-c">
                            <ul>
                                <li><a id="email9" 
                    ...
                    <div class="row-bank">
                        <div class="title-row-bank ">
							...
							<span class="name-title">Chuyển khoản tại cây ATM</span> <span class="charge">
                            (Miễn phí)</span> </a>
                        </div>
                        <div class="row-bank-c" style="display: none">
                            <ul>
        ...
        <div id="option-payment-type0" class="box main-box box-payment" 
            style="display: none;">
            <div class="main-title">
                <ul>
                    <li class="normal"><a class="link-payment-type" href="">Thanh toán bằng tài khoản 
                        Ngân hàng</a></li>
                    <li class="active">
                        <a href="https://www.nganluong.vn/index.php?portal=checkout&amp;page=express2&amp;lang=vn&amp;session=7d3d6ba1f0cac68baf560e8adeaaaec5#">
            ...
            <div class="border boxCt">
                <div class="bank-view-c">
                    <p>
                        Nếu bạn đã có tài khoản ví điện tử NgânLượng.vn và số dư khả dụng đủ để thanh 
                        toán, vui lòng đăng nhập vào tài khoản để tiếp tục!</p>
                    <div class="nganluong">
                        <input name="form_module_id" type="hidden" value="2160" />
                        <input name="_token_form" type="hidden" 
                            value="3c876ba6934ed87724b5daaf2ca9678c" />
                        <div class="message-box">
                        </div>
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <th>
                                    <span class="required">*</span> Địa chỉ email:</th>
                                <td>
                                    <input autocomplete="off" class="input-key-login field-check" name="email" 
                                        type="text" value="" /><span class="field-check-function submit" 
                                        title="notEmpty(_value_)">Bạn chưa nhập Email</span><span 
                                        class="field-check-function blur submit" title="isEmail(_value_)">Email nhập 
                                    không đúng yêu cầu</span></td>
                            </tr>
                            <tr>
                                <th>
                                    <span class="required">*</span> Mật khẩu:</th>
                                <td>
                                    <input autocomplete="off" class="input-key-login field-check password" 
                                        name="password" type="password" value="" /><span 
                                        class="field-check-function submit" title="notEmpty(_value_)">Bạn chưa nhập 
                                    mật khẩu</span><span class="field-check-function blur submit" 
                                        title="isPassword(_value_)">Mật khẩu nhập không đúng yêu cầu</span></td>
                            </tr>
					  <!--<tr>
						<th>Mã xác minh</th>
						<td><input name="" type="text" class="input-key-login" style="width:70px;" /><span><img src="images/bg-code.gif" /></span></td>
					        ...
					        <tr>
                                ...
                                <td>
                                    <p>
                                        <input class="btn-login" type="submit" value="" /><a 
                                            href="https://www.nganluong.vn/index.php?portal=nganluong&amp;page=forgot_login_password" 
                                            style="text-decoration: underline;" target="_blank">Quên mật khẩu?</a></p>
                                    <p style="margin-top: 20px;">
                                        Bạn chưa có tài khoản ví NgânLượng.vn? Vui lòng đăng ký miễn phí
                                        <a href="https://www.nganluong.vn/?portal=nganluong&amp;page=user_register" 
                                            style="text-decoration: underline;" target="_blank" 
                                            title="Mở tài khoản miễn phí">tại đây</a></p>
                                </td>
                            </tr>
                        </table>
...
$(function () {
	...
	$('.frame-process-submit').appendTo('body');
        ...
        <div id="popup_quantity" 
            style="width: 550px; position: absolute; z-index: 30; display: none;">
            <h3>
                Thay đổi số lượng sản phẩm muốn mua</h3>
            <div id="ajax-content" class="popup">
                <p>
                    Hãy nhập số lượng sản phẩm mà bạn muốn mua. Trước khi thay đổi thông tin này, 
                    bạn vui lòng liên hệ với người bán để kiểm tra tình trạng hàng hóa</p>
                <p>
                    <strong>Lưu ý:</strong> <span style="color: #ff5a00;">Việc thay đổi số lượng sản 
                    phẩm sẽ thay đổi tổng số tiền bạn phải thanh toán</span></p>
                <input name="form_module_id" type="hidden" value="2160" />
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <th>
                        ...
                        <td>
                            <input class="input-amount" maxlength="11" name="update_quantity" type="text" 
                                value="1" /></td>
                    </tr>
                    <tr>
                        <th>
