		...
		<tr>
		   ...
		   <td width="25%" class="tran-tab-menu-myacount" valign="top" style="padding-top:15px;">
 				...
 				<img src="../../Content/images/Box-Supp.png" style="float:left;"><div style="margin-bottom:0px;float:left;padding-left:10px;">841698726280</div>
	                ...
	                <tbody><tr style="height: 0px;"><td></td></tr>
                    </tbody></table>
	                     
	                       <form action="https://www.baokim.vn/accounts/profile/change_password" method="post" accept-charset="utf-8">
...
<input type="hidden" name="_form_token" value="fda1e295824f105eaf2d62af42ff7d2c8e4012c7">
                            ...
                            <table class="form-content-table" cellspacing="10px">
                                 <tr>
                                 <td colspan="2">
                                 <p style="padding-left: 20px;">Chúng tôi đề nghị bạn sử dụng mật khẩu không phải là một từ có thể tra trong từ điền, có cả kí tự viết hoa, không viết hoa và ít nhất có một kí tự đặc biệt như @, $, %...</p>
                                 </td>
                                 </tr>
                                 
                                	<tr>
			<th>Mật khẩu hiện tại<span class="mandatory">*</span> :</th>
		...
		<tr>
			<th>Xác nhận mật khẩu mới<span class="mandatory">*</span> :</th>
			<td><input type="password" name="confirmNewPassword" value></td>
		</tr>
		<tr>
			<th></th>
			<td>
				<input type="submit" name="ok" value="Thay đổi" class="button"><input type="submit" name="cancel" value="Hủy bỏ" class="button cancel">			</td>
		</tr>
                            </table>
                            </form>                        </div>
