        ...
        <div id="menu-nav-content-c">
            <div id="menu-nav-content-main">
                <ul>
                    ...
                    <li class="active " style="display: block"><a href="/Account/ThongTinTaiKhoan"><span>
                        TÀI KHOẢN</span></a></li>
                </ul>
            </div>
    ...
    <div id="menu-vertical">
        <div id="menu-vertical-right">
            <div id="merchant_integrate_new">
                <div class="menu-vertical-right-content-list" style="padding: 20px 15px 10px 15px;
                    border: 1px solid #A5B4BC; border-top: none;">
                    <div id="account-info-title-no-underline">
                        <span class="yel">Thay đổi mật khẩu đăng nhập tài khoản</span> &nbsp;&nbsp;<span>[ <a
                            target="_parent" href="/Account/ThongTinTaiKhoan">Xem thông tin tài khoản</a> ]</span>
                    </div>
                    <div id="acc-changepassword" style="padding: 0 1px 0 0; border: none;">
                        ...
                        <input type="hidden" name="form_module_id" value="1641">
                        <div class="message-box">
                        </div>
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <th style="width: 200px;">
                                    <span class="required">*</span>Mật khẩu đăng nhập cũ:
                                </th>
                                <td>
                            ...
                            <tr>
                                <th>
                                    <span class="required">*</span>Mật khẩu đăng nhập mới:
                                </th>
                                <td>
                            ...
                            <tr>
                                <th>
                                    <span class="required">*</span>Nhập lại mật khẩu đăng nhập mới:
                                </th>
                                <td>
                                    <input type="password" autocomplete="off" style="width: 200px;" name="renew_pass"
                                        size="30" value class="field-check keyboardInput"><div class="field-notification field-alert">
                                            Nhập lại mật khẩu đăng nhập mới từ 6-20 ký tự, không bao gồm khoảng trống</div>
                                    <span class="field-check-function submit" title="notEmpty(_value_)">Bạn chưa nhập lại
                                        mật khẩu đăng nhập</span><span class="field-check-function blur submit" title="isPassword(_value_)">Nhập
                                            lại mật khẩu đăng nhập chưa đúng quy tắc</span><span class="field-check-function blur"
                                                title="isConfirmObject(_value_,'new_pass')">Nhập lại mật khẩu đăng nhập chưa chính
                                                xác</span>
                                </td>
                            </tr>
                            <tr>
