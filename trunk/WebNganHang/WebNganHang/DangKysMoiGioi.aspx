<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DangKysMoiGioi.aspx.cs" Inherits="WebNganHang.DangKysMoiGioi" %>
...
<div id="mx_loginbox">
    ...
    <tr>
        <td colspan="2" style="background-repeat: no-repeat; font-weight: bold; font-style: italic; text-transform: capitalize; color: #FF0000; vertical-align: middle; text-align: center;">
     ...
     <tr>
        ...
        <td colspan="2" style="background-repeat: no-repeat; font-weight: bold; font-style: italic; text-transform: capitalize; color: #FF0000; vertical-align: middle; text-align: center;"  >Thông Tin tài khoản&nbsp;
    ...
    <tr>
        <td width="20%">
            Số GPKD</td>
        <td>
            <asp:TextBox ID="txtGPKD" runat="server" Width="216px"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" 
                ControlToValidate="txtGPKD" ErrorMessage="(*)"></asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
        <td width="20%">
           Tên Cơ Quan</td>
        <td>
            <asp:TextBox ID="txtTenCty" runat="server" Width="216px"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" 
                ControlToValidate="txtTenCty" ErrorMessage="(*)"></asp:RequiredFieldValidator>
        </td>
    </tr>
    ...
    <tr>
        <td width="20%">
            Địa Chỉ</td>
        <td>
            <asp:TextBox ID="txtDiaChi" runat="server" Width="216px"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td width="20%">
    ...
    <tr>
     ...
     <tr>
        <td width="20%">
            Điện Thoại/fax</td>
        <td>
            <asp:TextBox ID="txtDienThoai" runat="server" Width="216px"></asp:TextBox>
