...
{
    public partial class DangKysMoiGioi : System.Web.UI.Page
    {
        ...
        {
            //int seed = int.Parse(txtCMND.Text);
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            dc.SoNha = int.Parse(txtDiaChi.Text);
            ...
            if (mail.Count() > 0)
            {
                ...
                lblemail.Text = "email nay da dc dung";
                flag = 1;
            ...
            var gpkd = from gp in db1.MoiGiois where txtGPKD.Text.Equals(gp.SoGiayPhepKinhDoanh) || txtTenCty.Text.Equals(gp.TenCongTy) select gp.SoGiayPhepKinhDoanh;
            if (gpkd.Count() > 0)
            {

                //lbInform.Visible = true;
                lblThongTin.Text = "GPKD hoặc Tên Cty ko hợp lệ";
                flag = 1;
            ...
            //mg.SoGiayPhepKinhDoanh = txtGPKD.Text.ToString();
            mg.TenCongTy = txtTenCty.Text.ToString();
            mg.DienThoaiCongTy = int.Parse(txtDienThoai.Text);
            db1.MoiGiois.InsertOnSubmit(mg);
            if (flag == 0)
            {
                db1.SubmitChanges();
                lbInform.Visible = true;
