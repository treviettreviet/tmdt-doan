<%@ Page Title="" Language="C#" MasterPageFile="~/Site_TTTaiKhoan.Master" AutoEventWireup="true" CodeBehind="TaiKhoan.aspx.cs" Inherits="MoiGioi_Money10.WebForm11" %>
...
<div id="menu-nav-content">
	...
	<div id="menu-nav-content-c">
		<div id="menu-nav-content-main">
			<ul>
				...
				<li class="active " style="display:block"><a href="https://www.nganluong.vn/?portal=nganluong&amp;page=user_info"><span>TÀI KHOẢN</span></a></li>
		...
		<div id="menu-nav-content-sub">
			<ul>
				...
				<li class="active " style="display:block"><a href="https://www.nganluong.vn/?portal=nganluong&amp;page=user_info"><span>Tổng hợp</span></a></li>
            ...
            <tr>
			 ...
			 <tr>
			  ...
			  <tr>
				...
				<td><img src="../images/un_verif.png" style="float:left">&nbsp;&nbsp;&nbsp;[ <a href="https://www.nganluong.vn/?portal=nganluong&amp;page=user_verify_request">Chứng thực</a> ]</td>
			  </tr>
			<tr>
    ...
    <li class="active"><a href="https://www.nganluong.vn/?portal=nganluong&amp;page=user_info">Thông tin tài khoản</a></li>
