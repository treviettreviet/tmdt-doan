<%@ Page Title="" Language="C#" MasterPageFile="~/Site_TTTaiKhoan.Master" AutoEventWireup="true" CodeBehind="LichSuGiaoDich.aspx.cs" Inherits="MoiGioi_Money10.WebForm10" %>
    ...
    <div id="transaction-history" class="box-content-square">
            ...
            <div id="popup-applicant" 
                ...
                <p style="color:#FF7007; font-size:13px">
                    <strong>CÁC TRƯỜNG CẦN TRÍCH XUẤT</strong><span style="float:right"><a 
                        ...
                        src="../images/close-me.gif" /></a></span></p>
                <br />
        ...
        <div id="label-table" style="border-top:0;background-color:#fff;">
            ...
            <div style=" float:right;height:16px;">
                ...
                <img align="absmiddle" src="../images/icon_tra.gif" /> <span>Chưa thực hiện</span>
                <img align="absmiddle" src="../images/icon_trb.gif" /> <span>Đang tạm giữ</span>
                <img align="absmiddle" src="../images/icon_trc.gif" /> <span>Ðã hoàn thành</span>
                <img align="absmiddle" src="../images/icon_trd.gif" /> <span>Bị từ chối</span>
            </div>
        </div>
