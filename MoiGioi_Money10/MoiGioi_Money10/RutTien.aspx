<%@ Page Title="" Language="C#" MasterPageFile="~/Site_TTTaiKhoan.Master" AutoEventWireup="true" CodeBehind="RutTien.aspx.cs" Inherits="MoiGioi_Money10.WebForm8" %>
	...
	<div id="menu-nav-content-c">
		...
		<div id="menu-nav-content-sub">
			<ul>
				...
				<li class="active " style="display:block"><a href="https://www.nganluong.vn/?portal=nganluong&amp;page=withdraw"><span>Rút tiền</span></a></li>
		...
		<div>
		  ...
		  <table border="0" cellspacing="10" cellpadding="0" width="100%">
			  ...
			  <tr>
				...
				<td><input name="verify_image" type="text" class="input-business field-check" maxlength="5" autocomplete="off" style="width:80px;"><img src="R%FAt%20tiền%20_%20Ng%E2nLượng.vn_files/captcha0.gif" border="0" style="margin-left:10px;" align="absmiddle">
