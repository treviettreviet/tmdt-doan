...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% using (Html.BeginForm("XuLyUpdateThe","Public")) {%>
        ...
        <fieldset>
            ...
            <div class="editor-field">
                <%: Html.TextBoxFor(model => model.SoBaoMat,new Dictionary<string, object>() { { "readonly", "true" } })%>
            ...
            <div class="editor-field">
                <%: Html.TextBoxFor(model => model.SoDu,new Dictionary<string, object>() { { "readonly", "true" } })%>
            ...
            <div class="editor-field">
                <%: Html.TextBoxFor(model => model.SoPin, new Dictionary<string, object>() { { "readonly", "true" } })%>
            ...
            <div class="editor-field">
                <%: Html.TextBoxFor(model => model.NgayMoThe, new Dictionary<string, object>() { { "readonly", "true" } })%>
            ...
            <div class="editor-field">
                <%: Html.TextBoxFor(model => model.NgayHetHan, new Dictionary<string, object>() { { "readonly", "true" } })%>
            ...
            <div class="editor-field">
                <%: Html.TextBoxFor(model => model.TinhTrang, new Dictionary<string, object>() { { "readonly", "true" } })%>
